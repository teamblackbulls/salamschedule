...
<body>
	...
	try {
		...
		String sql = "SELECT * FROM staff INNER JOIN schedule ON staff.id =schedule.imamid OR staff.id=schedule.bilalid WHERE staff.staffid1 ='" + staffid1 + "'";
				...
				<table class="table table-striped" style="width:100%" >
				 ...
				 <c:forEach items="${schedules}" var="sc" varStatus="schedules">
				  <tr>
				    ...
				    <td><a class="btn btn-warning" href="addReschedule.jsp" >Reschedule</a></td>
				  </tr>
				  </c:forEach>       
				</table>
			</div>
